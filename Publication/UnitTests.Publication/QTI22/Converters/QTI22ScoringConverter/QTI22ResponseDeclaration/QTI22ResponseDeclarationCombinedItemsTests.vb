...
<TestClass()>
Public Class QTI22ResponseDeclarationCombinedItemsTests
    ...
    Public Sub Combined_NoFinding_Test()
        RunResponseDeclarationTest(_itemBody1, _solution1, GetScoringParams(), _result1, 18)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub TFS_26798_Test()
        RunResponseDeclarationTest(_itemBody2, _solution6, Nothing, _result6, 2)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub TFS_28312_GapDateTime_Test()
        RunResponseDeclarationTest(_itemBody3, _solution7, Nothing, _result7, 11)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub TFS_28312_GapMatch_Test()
        RunResponseDeclarationTest(_itemBody4, _solution8, Nothing, _result8, 1)
    End Sub
                        ...
                        <p id="c1-id-11" xmlns="http://www.w3.org/1999/xhtml">Tekst <cito:InlineElement id="I48c06d9f-edb6-40f3-a759-df23c4d95e2f" layoutTemplateSourceName="CTE.InlineGapStringLayoutTemplate" inlineFO="IEF" xmlns:cito="http://www.cito.nl/citotester">
                                <cito:parameters>
                                    <cito:parameterSet id="entireItem">
                                        ...
                                        <cito:stringScoringParameter name="stringScoring" label="Tekst" ControllerId="gapController" findingOverride="IEF" expectedLength="10">
                        ...
                        <p id="c1-id-15" xmlns="http://www.w3.org/1999/xhtml">Datum <cito:InlineElement id="Ib946bb76-51f2-4a58-b865-c5aef235a439" layoutTemplateSourceName="CTE.InlineGapDateLayoutTemplate" inlineFO="IEF" xmlns:cito="http://www.cito.nl/citotester">
                                <cito:parameters>
                                    <cito:parameterSet id="entireItem">
                                        ...
                                        <cito:listedparameter name="dateSubType">dd-MM-yyyy</cito:listedparameter>
                                        <cito:booleanparameter name="showEditMask">False</cito:booleanparameter>
                                        <cito:booleanparameter name="showInvalidCharacterAudio">False</cito:booleanparameter>
                                        <cito:booleanparameter name="showInvalidCharacterMessage">False</cito:booleanparameter>
                                        <cito:plaintextparameter name="invalidCharacterMessage">U kunt alleen de volgende tekens invoeren ...</cito:plaintextparameter>
                        ...
                        <p id="c1-id-16" xmlns="http://www.w3.org/1999/xhtml">Tijd (hh:mm:ss) <cito:InlineElement id="Ie2c5a24d-8187-4ab3-bb89-cb31d1a250da" layoutTemplateSourceName="CTE.InlineGapTimeLayoutTemplate" inlineFO="IEF" xmlns:cito="http://www.cito.nl/citotester">
                                <cito:parameters>
                                    <cito:parameterSet id="entireItem">
                                        ...
                                        <cito:listedparameter name="timeSubType">hh:mm:ss</cito:listedparameter>
                                        <cito:booleanparameter name="showEditMask">False</cito:booleanparameter>
                                        <cito:booleanparameter name="showInvalidCharacterAudio">False</cito:booleanparameter>
                                        <cito:booleanparameter name="showInvalidCharacterMessage">False</cito:booleanparameter>
                                        <cito:plaintextparameter name="invalidCharacterMessage">U kunt alleen de volgende tekens invoeren ...</cito:plaintextparameter>
                        ...
                        <p id="c1-id-20" xmlns="http://www.w3.org/1999/xhtml">Choice <cito:InlineElement id="Ibe763973-0fb7-42da-aadb-32950e644bfd" layoutTemplateSourceName="CTE.InlineChoiceLayoutTemplate" inlineFO="IEF" xmlns:cito="http://www.cito.nl/citotester">
                                <cito:parameters>
                                    <cito:parameterSet id="entireItem">
                                        ...
                                        <cito:inlineChoiceScoringparameter name="inlineChoiceScoring" label="IC1" ControllerId="inlineChoiceController" findingOverride="IEF" minChoices="0" maxChoices="1">
                                ...
                                <cito:parameters>
                                    <cito:parameterSet id="entireItem">
                                        ...
                                        <cito:inlineChoiceScoringparameter name="inlineChoiceScoring" label="IC2" ControllerId="inlineChoiceController" findingOverride="IEF" minChoices="0" maxChoices="1">
                                            <cito:subparameterset id="A">
                                                <cito:xhtmlparameter name="icOption">
                                ...
                                <cito:parameters>
                                    <cito:parameterSet id="entireItem">
                                        ...
                                        <cito:inlineChoiceScoringparameter name="inlineChoiceScoring" label="IC3" ControllerId="inlineChoiceController" findingOverride="IEF" minChoices="0" maxChoices="1">
                                            <cito:subparameterset id="A">
                                                <cito:xhtmlparameter name="icOption">
                        ...
                        <p id="c1-id-22" xmlns="http://www.w3.org/1999/xhtml">Meerkeuze 1<br id="c1-id-23"/><cito:InlineElement id="I5e9be57a-1cc0-4501-804b-f89bbb666852" layoutTemplateSourceName="CTE.InlineMultipleChoiceLayoutTemplate" inlineFO="IEF" xmlns:cito="http://www.cito.nl/citotester">
                                <cito:parameters>
                                    <cito:parameterSet id="entireItem">
                                        ...
                                        <cito:multichoicescoringparameter name="inlineMCScoring" label="MC1" ControllerId="inlineMC" findingOverride="IEF" minChoices="1" maxChoices="1" multiChoice="Radio">
                                            <cito:subparameterset id="A">
                        ...
                        <p id="c1-id-25" xmlns="http://www.w3.org/1999/xhtml">Meerkeuze 2<br id="c1-id-26"/><cito:InlineElement id="Ib072620d-58c8-4695-b219-6591412548ff" layoutTemplateSourceName="CTE.InlineMultipleChoiceLayoutTemplate" inlineFO="IEF" xmlns:cito="http://www.cito.nl/citotester">
                                <cito:parameters>
                                    <cito:parameterSet id="entireItem">
                                        ...
                                        <cito:integerparameter name="expectedAnswers">1</cito:integerparameter>
                                        <cito:integerparameter name="multiChoiceType">1</cito:integerparameter>
                                        <cito:multichoicescoringparameter name="inlineMCScoring" label="MC2" ControllerId="inlineMC" findingOverride="IEF" minChoices="1" maxChoices="1" multiChoice="Radio">
                                            <cito:subparameterset id="A">
                                                <cito:xhtmlparameter name="mcOption">
                                                    <p id="c1-id-11" xmlns="http://www.w3.org/1999/xhtml">A.A</p>
                                                </cito:xhtmlparameter>
                        ...
                        <p id="c1-id-30" xmlns="http://www.w3.org/1999/xhtml">Multiple Response<br id="c1-id-32"/><cito:InlineElement id="Id8d3499a-99fa-446d-a588-6216b3ae6109" layoutTemplateSourceName="CTE.InlineMultipleResponseLayoutTemplate" inlineFO="IEF" xmlns:cito="http://www.cito.nl/citotester">
                                <cito:parameters>
                                    <cito:parameterSet id="entireItem">
                                        ...
                                        <cito:integerparameter name="multiChoiceType">1</cito:integerparameter>
                                        <cito:multichoicescoringparameter name="inlineMCScoring" label="MR" ControllerId="inlineMC" findingOverride="IEF" minChoices="0" maxChoices="0" multiChoice="Radio">
                                            <cito:subparameterset id="A">
                                                <cito:xhtmlparameter name="mcOption">
                                                    <p id="c1-id-11" xmlns="http://www.w3.org/1999/xhtml">a</p>
                                                </cito:xhtmlparameter>
           ...
           <itemBody class="defaultBody">
               <div class="content">
                   ...
                   <div xmlns="http://www.w3.org/1999/xhtml">
                       <div id="itemquestion">
                           <p id="c1-id-11">Tekst <textEntryInteraction patternMask="^.{0,10}$" responseIdentifier="I48c06d9f-edb6-40f3-a759-df23c4d95e2f" expectedLength="10"/>
                           </p>
                           <p id="c1-id-12">Geheel getal <textEntryInteraction patternMask="^-?([0-9]{1,5})?$" responseIdentifier="Ie4b22c84-5b60-4e02-a4bf-df6dd36cc504" expectedLength="6"/>
                           </p>
                           <p id="c1-id-13">Decimaal <textEntryInteraction patternMask="^-?([0-9]{1,6})?(([\,])([0-9]{0,2}))?$" responseIdentifier="I7063ab42-3f7e-432f-a6bc-fa3f3867e617" expectedLength="9"/>
                           </p>
                           <p id="c1-id-14">Bedrag <textEntryInteraction patternMask="^-?([0-9]{1,5})?(([\,])([0-9]{0,2}))?$" responseIdentifier="I05fc1135-87b1-4070-9f1b-44396624a85c" expectedLength="8"/>
                           </p>
                           <p id="c1-id-15">Datum <span>
                                   <textEntryInteraction patternMask="^(?![0])(([0-2]?[0-9])|([3][0-1]))$" responseIdentifier="Ib946bb76-51f2-4a58-b865-c5aef235a439" expectedLength="2" dateSubType="dutch"/>
								    
								        -
								    
							  
								    <textEntryInteraction patternMask="^(?![0])(([0-9])|([1][0-2]))$" responseIdentifier="Ib946bb76-51f2-4a58-b865-c5aef235a439" expectedLength="2" dateSubType="dutch"/>
								    
								        -
								    
							  
								    <textEntryInteraction patternMask="^([0-9]{1,4})$" responseIdentifier="Ib946bb76-51f2-4a58-b865-c5aef235a439" expectedLength="4" dateSubType="dutch"/>
                               </span>
                           </p>
                           <p id="c1-id-16">Tijd (hh:mm:ss) <span>
                                   <textEntryInteraction patternMask="^(([0-1]?[0-9])|([2][0-3]))$" responseIdentifier="Ie2c5a24d-8187-4ab3-bb89-cb31d1a250da" expectedLength="2" timeSubType="hhmmss"/>
							  
								    :
								    
								    <textEntryInteraction patternMask="^([0-5]?[0-9])$" responseIdentifier="Ie2c5a24d-8187-4ab3-bb89-cb31d1a250da" expectedLength="2" timeSubType="hhmmss"/>
                           ...
                           <p id="c1-id-17">Formule <textEntryInteraction id="If8544370-1046-4080-9dda-3cf3077d9384" responseIdentifier="If8544370-1046-4080-9dda-3cf3077d9384"/>
                           </p>
                           <p id="c1-id-18">Formule (meerregelig) <extendedTextInteraction id="Ifd8a5530-6ab4-43f7-a25c-372d1dd4570f" responseIdentifier="Ifd8a5530-6ab4-43f7-a25c-372d1dd4570f" isFormulaEditor="True"/>
                           </p>
                           <p id="c1-id-20">Choice <inlineChoiceInteraction id="Ibe763973-0fb7-42da-aadb-32950e644bfd" responseIdentifier="Ibe763973-0fb7-42da-aadb-32950e644bfd" shuffle="false" required="true">
                                   <inlineChoice identifier="A"/>
                                   <inlineChoice identifier="B"/>
                                   <inlineChoice identifier="C"/>
                                   <inlineChoice identifier="D"/>
                               </inlineChoiceInteraction> en choice 2 <inlineChoiceInteraction id="I2ebb2bdb-2ab2-4919-8d65-b6f218999a1c" responseIdentifier="I2ebb2bdb-2ab2-4919-8d65-b6f218999a1c" shuffle="false" required="true">
                                   <inlineChoice identifier="A"/>
                                   <inlineChoice identifier="B"/>
                                   <inlineChoice identifier="C"/>
                                   <inlineChoice identifier="D"/>
                               </inlineChoiceInteraction> en choice 3 <inlineChoiceInteraction id="Ibf865980-8621-4005-a520-3ad82bff7aae" responseIdentifier="Ibf865980-8621-4005-a520-3ad82bff7aae" shuffle="false" required="true">
                                   <inlineChoice identifier="A"/>
                                   <inlineChoice identifier="B"/>
                                   <inlineChoice identifier="C"/>
                           ...
                           <p id="c1-id-22">Meerkeuze 1<br id="c1-id-23"/>
                               <choiceInteraction id="I5e9be57a-1cc0-4501-804b-f89bbb666852" class="" shuffle="false" responseIdentifier="I5e9be57a-1cc0-4501-804b-f89bbb666852" maxChoices="1">
                                   <simpleChoice identifier="I5e9be57a-1cc0-4501-804b-f89bbb666852A">
                                       <p id="c1-id-11">A</p>
                                   </simpleChoice>
                                   <simpleChoice identifier="I5e9be57a-1cc0-4501-804b-f89bbb666852B">
                                       <p id="c1-id-11">B</p>
                                   </simpleChoice>
                                   <simpleChoice identifier="I5e9be57a-1cc0-4501-804b-f89bbb666852C">
                                       <p id="c1-id-11">C</p>
                                   </simpleChoice>
                               </choiceInteraction>
                           </p>
                           <p id="c1-id-25">Meerkeuze 2<br id="c1-id-26"/>
                               <choiceInteraction id="Ib072620d-58c8-4695-b219-6591412548ff" class="" shuffle="false" responseIdentifier="Ib072620d-58c8-4695-b219-6591412548ff" maxChoices="1">
                                   <simpleChoice identifier="Ib072620d-58c8-4695-b219-6591412548ffA">
                                       <p id="c1-id-11">A.A</p>
                                   </simpleChoice>
                                   <simpleChoice identifier="Ib072620d-58c8-4695-b219-6591412548ffB">
                                       <p id="c1-id-11">B.B</p>
                                   </simpleChoice>
                                   <simpleChoice identifier="Ib072620d-58c8-4695-b219-6591412548ffC">
                                       <p id="c1-id-11">C.C</p>
                                   </simpleChoice>
                                   <simpleChoice identifier="Ib072620d-58c8-4695-b219-6591412548ffD">
                                       <p id="c1-id-11">D.D</p>
                                   </simpleChoice>
                               </choiceInteraction>
                           </p>
                           <p id="c1-id-30">Multiple Response<br id="c1-id-32"/>
                               <choiceInteraction id="Id8d3499a-99fa-446d-a588-6216b3ae6109" class="" shuffle="false" responseIdentifier="Id8d3499a-99fa-446d-a588-6216b3ae6109" maxChoices="0">
                                   <simpleChoice identifier="Id8d3499a-99fa-446d-a588-6216b3ae6109A">
                                       <p id="c1-id-11">a</p>
                                   </simpleChoice>
                                   <simpleChoice identifier="Id8d3499a-99fa-446d-a588-6216b3ae6109B">
                                       <p id="c1-id-11">b</p>
                                   </simpleChoice>
                                   <simpleChoice identifier="Id8d3499a-99fa-446d-a588-6216b3ae6109C">
                                       <p id="c1-id-11">c</p>
                                   </simpleChoice>
                                   <simpleChoice identifier="Id8d3499a-99fa-446d-a588-6216b3ae6109D">
                                       <p id="c1-id-11">d</p>
                                   </simpleChoice>
                                   <simpleChoice identifier="Id8d3499a-99fa-446d-a588-6216b3ae6109E">
                                       <p id="c1-id-11">e</p>
                                   </simpleChoice>
                               </choiceInteraction>
                           </p>
                    ...
                    <div class="div_right" xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <div class="div_right_inner">
                            <div id="itemquestion">
                                ...
                                <p id="c1-id-15">Hadawa<inlineChoiceInteraction responseIdentifier="I86634265-270f-46ea-8c73-4f6510e16068" shuffle="false" required="true">
                                        <inlineChoice identifier="A">optie A</inlineChoice>
                                        <inlineChoice identifier="B">optie B</inlineChoice>
                                        <inlineChoice identifier="C">optie C</inlineChoice>
                                    </inlineChoiceInteraction>wanneer</p>
                                <p id="c1-id-16">Bada<inlineChoiceInteraction responseIdentifier="I4c1a66d2-86aa-4755-be91-4cf664e059ed" shuffle="false" required="true">
                                ...
                                <tbody id="c1-id-18">
                                    ...
                                    <tr style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid" id="c1-id-36">
                                        ...
                                        <td style="BORDER-BOTTOM: black 1px solid;PADDING-BOTTOM: 3px;PADDING-LEFT: 3px;PADDING-RIGHT: 3px;BORDER-RIGHT: black 1px solid;PADDING-TOP: 3px;" id="c1-id-39">
                                            <p id="c1-id-40">
                                                <textEntryInteraction patternMask="^.{0,2}$" responseIdentifier="I6be3d96d-b21a-403d-ad73-6e8f35d816ef" expectedLength="2"/> meegaat op schoolreis en ga akkoord met de kosten. Deze zal ik per bank overmaken.</p>
                                        </td>
                                    </tr>
                                    <tr style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid" id="c1-id-41">
                                        ...
                                        <td style="BORDER-BOTTOM: black 1px solid;PADDING-BOTTOM: 3px;PADDING-LEFT: 3px;PADDING-RIGHT: 3px;BORDER-RIGHT: black 1px solid;PADDING-TOP: 3px;" id="c1-id-45">
                                            <p id="c1-id-46">
                                                <textEntryInteraction patternMask="^.{0,30}$" responseIdentifier="I9d223733-c393-4c55-9f86-7b6e9d13d8a0" expectedLength="30"/>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid" id="c1-id-47">
                                        ...
                                        <td style="BORDER-BOTTOM: black 1px solid; PADDING-BOTTOM: 3px; PADDING-LEFT: 3px; PADDING-RIGHT: 3px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; PADDING-TOP: 3px" id="c1-id-50">
                                            <p id="c1-id-51">
                                                <textEntryInteraction patternMask="^.{0,10}$" responseIdentifier="Ib0f9a278-9f9f-43fd-be24-1120f39ab250" expectedLength="10"/> <span>
                                                    <textEntryInteraction patternMask="^(([0-1]?[0-9])|([2][0-3]))$" responseIdentifier="I6f1d0321-bc36-411e-a323-22aa9c07f17e" expectedLength="2" timeSubType="hhmmss"/>
								
									:
									
									<textEntryInteraction patternMask="^([0-5]?[0-9])$" responseIdentifier="I6f1d0321-bc36-411e-a323-22aa9c07f17e" expectedLength="2" timeSubType="hhmmss"/>
                                    ...
                                    <tr style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid" id="c1-id-52">
                                        ...
                                        <td style="BORDER-BOTTOM: black 1px solid; PADDING-BOTTOM: 3px; PADDING-LEFT: 3px; PADDING-RIGHT: 3px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid; PADDING-TOP: 3px" id="c1-id-55">
                                            <p id="c1-id-56">
                                                <span>
                                                    <textEntryInteraction patternMask="^(?![0])(([0-2]?[0-9])|([3][0-1]))$" responseIdentifier="Idfde9b07-cbd9-49ac-b790-0bfdb2fbe8f6" expectedLength="2" dateSubType="dutch"/>
									
									-
									
								
									<textEntryInteraction patternMask="^(?![0])(([0-9])|([1][0-2]))$" responseIdentifier="Idfde9b07-cbd9-49ac-b790-0bfdb2fbe8f6" expectedLength="2" dateSubType="dutch"/>
									
									-
									
								
									<textEntryInteraction patternMask="^([0-9]{1,4})$" responseIdentifier="Idfde9b07-cbd9-49ac-b790-0bfdb2fbe8f6" expectedLength="4" dateSubType="dutch"/>
                                                </span>    <extendedTextInteraction responseIdentifier="If6d80e16-db5d-4be6-89e9-3044c7cf36a9" expectedLines="5" expectedLength="0"/>
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <p id="c1-id-62">
                                <em id="c1-id-63">
                                    <em id="c1-id-64">
                                        <em id="c1-id-65">
                                            <em id="c1-id-66">
                                                <extendedTextInteraction responseIdentifier="I1a0e068a-5825-4566-baf6-cc3662e2f7d5" expectedLines="1" expectedLength="0"/>
                                            </em>
                                        </em>
                                    </em>
                                </em>
                    ...
                    <div>
                        <div id="itemquestion">
                            <gapMatchInteraction responseIdentifier="gapMatchController" shuffle="false">
                                <gapText identifier="A" matchMax="3">jou</gapText>
                                <gapText identifier="B" matchMax="3">jouw</gapText>
                                <p id="c1-id-11">
                                    <strong id="c1-id-12">juist..</strong>
                                </p>
                                <p id="c1-id-13">Het .. <span>
                                        <gap identifier="Icdc09f4f-2ce5-44fa-8964-aa27e0a589bf" required="true"/>
                                    </span> terug... </p>
                                <p id="c1-id-14">Ik geef <span>
                                        <gap identifier="I4c0faece-4936-4dc0-bcef-728acc334870" required="true"/>
                                    </span>snel .. <span>
                                        <gap identifier="I301ac896-7857-4190-9186-a60406f986a6" required="true"/>
                                    </span> terug.</p>
                                <p id="c1-id-15"> </p>
                                <p id="c1-id-16">
                                    <em id="c1-id-17">
    ...
    Private _result1 As XElement =
        <responseDeclarations>
            ...
            <responseDeclaration identifier="RESPONSE12" cardinality="ordered" baseType="string"/>
            <responseDeclaration identifier="RESPONSE13" cardinality="single" baseType="string"/>
            <responseDeclaration identifier="RESPONSE14" cardinality="single" baseType="string"/>
            <responseDeclaration identifier="RESPONSE15" cardinality="single" baseType="string"/>
            <responseDeclaration identifier="RESPONSE16" cardinality="single" baseType="string"/>
            <responseDeclaration identifier="RESPONSE17" cardinality="single" baseType="string"/>
            <responseDeclaration identifier="RESPONSE18" cardinality="multiple" baseType="string"/>
        </responseDeclarations>
    ...
    Private _result8 As XElement =
        <responseDeclarations>
            <responseDeclaration identifier="RESPONSE" cardinality="multiple" baseType="directedPair">
                <correctResponse interpretation="A Icdc09f4f-2ce5-44fa-8964-aa27e0a589bf&amp;B I4c0faece-4936-4dc0-bcef-728acc334870&amp;A I301ac896-7857-4190-9186-a60406f986a6">
                    <value>A Icdc09f4f-2ce5-44fa-8964-aa27e0a589bf</value>
                    <value>B I4c0faece-4936-4dc0-bcef-728acc334870</value>
                    <value>A I301ac896-7857-4190-9186-a60406f986a6</value>
                </correctResponse>
            </responseDeclaration>
        </responseDeclarations>
