...
Public Class QTI22ResponseProcessingCustomInteractionTests
    ...
    Public Sub GetResponseProcessingForCombinationOfFactSetsAndFactsOnFinding_Dichotomous_Test()
        Dim scoringPrms As HashSet(Of ScoringParameter) = GetCustomInteractionScoringParams()
        RunResponseProcessingTest(_itemBody1, _finding5, _responseProcessing5, scoringPrms, New QTI22CombinedScoringConverter(scoringPrms))
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseProcessing")>
    Public Sub GetResponseProcessingForMultipleFactSets_Polytomous_Test()
        Dim scoringPrms As HashSet(Of ScoringParameter) = GetCustomInteractionScoringParams()
        RunResponseProcessingTest(_itemBody1, _finding2, _responseProcessing2, scoringPrms, New QTI22CombinedScoringConverter(scoringPrms))
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseProcessing")>
    Public Sub GetResponseProcessingForMultipleFactSets_Dichotomous_Test()
        Dim scoringPrms As HashSet(Of ScoringParameter) = GetCustomInteractionScoringParams()
        RunResponseProcessingTest(_itemBody1, _finding6, _responseProcessing6, scoringPrms, New QTI22CombinedScoringConverter(scoringPrms))
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseProcessing")>
    Public Sub GetResponseProcessingForFactSetTest()
        Dim scoringPrms As HashSet(Of ScoringParameter) = GetCustomInteractionScoringParams()
        RunResponseProcessingTest(_itemBody1, _finding3, _responseProcessing3, scoringPrms, New QTI22CombinedScoringConverter(scoringPrms))
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseProcessing")>
    Public Sub GetResponseProcessingForFactsOnFinding_Polytomous_Test()
        Dim scoringPrms As HashSet(Of ScoringParameter) = GetCustomInteractionScoringParams()
        RunResponseProcessingTest(_itemBody1, _finding4, _responseProcessing4, scoringPrms, New QTI22CombinedScoringConverter(scoringPrms))
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseProcessing")>
    Public Sub GetResponseProcessingForFactsOnFinding_Dichotomous_Test()
        Dim scoringPrms As HashSet(Of ScoringParameter) = GetCustomInteractionScoringParams()
        RunResponseProcessingTest(_itemBody1, _finding7, _responseProcessing7, scoringPrms, New QTI22CombinedScoringConverter(scoringPrms))
    End Sub
    ...
    Public Sub GetResponseProcessingForType3_Test()
        ...
        RunResponseProcessingTest(_itemBody_Type3, _finding_Type3_1, _responseProcessing_Type3, scoringPrms, New QTI22CombinedScoringConverter(scoringPrms))
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseProcessing")>
    Public Sub GetResponseProcessingForType4_Test()
        Dim scoringPrms As HashSet(Of ScoringParameter) = GetCustomInteractionScoringParams_Type3And4()
        RunResponseProcessingTest(_itemBody_Type4, _finding_Type4_1, _responseProcessing_Type4, scoringPrms, New QTI22CombinedScoringConverter(scoringPrms))
    End Sub
