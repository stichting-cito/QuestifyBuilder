...
<TestClass()>
Public Class QTI22OutcomeDeclarationTests
    ...
    Public Sub OneGroupOneFactOnFindingOneConcept_SixOutcomeDeclarations()
        ...
        Assert.AreEqual("SCORE", result(0).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept2-1", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_Concept2-1", result(2).identifier)
    ...
    Public Sub GM_CombinationOfFactSetsAndFactsOnFinding_OutcomeDeclarationsShouldBeInRightOrder()
        ...
        Assert.AreEqual("SCORE", result(0).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_EN-SC-4", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_EN-SC-4-1", result(2).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_EN-SC-1", result(3).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_EN-SC-4", result(4).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_EN-SC-4-1", result(5).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_EN-SC-2", result(6).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_EN-SC-3", result(7).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_EN-SC-3-1", result(8).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_EN-SC-4", result(9).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_EN-SC-4-1", result(10).identifier)
    ...
    Public Sub GGM_CombinationOfFactSetsAndFactsOnFinding_OutcomeDeclarationsShouldBeInRightOrder()
        ...
        Assert.AreEqual(11, result.Count)
        Assert.AreEqual("SCORE", result(0).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_1-Doel-en-Publiek", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_1-2-Rekening-houden-met-verhouding-tot-lezer", result(2).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_1-Doel-en-Publiek", result(3).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_1-1-Rekening-houden-met-voorkennis-lezer", result(4).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_2-Tekstopbouw", result(5).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_2-2-Passende-argumentstructuur-gebruiken-h-v-", result(6).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_3-Tekststructuur", result(7).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_3-1-Passende-tekstindeling-en-opmaak-gebruiken", result(8).identifier)
        Assert.AreEqual("CONCEPTRESPONSE5_2-Tekstopbouw", result(9).identifier)
        Assert.AreEqual("CONCEPTRESPONSE5_2-1-Hoofd--en-bijzaken-onderscheiden", result(10).identifier)
    ...
    Public Sub Gaps_CombinationOfMultipleFactSetsAndFactsOnFinding()
        ...
        Assert.AreEqual("SCORE", result(0).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_economie-2", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_economie-2", result(2).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_economie-2-2", result(3).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_economie-1", result(4).identifier)
    ...
    Public Sub HottextCorrection_FactsOnFinding_OutcomeDeclarationsShouldBeInRightOrder()
        ...
        Assert.AreEqual("SCORE", result(0).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept1", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept1-1", result(2).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_Concept1", result(3).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_Concept1-2", result(4).identifier)
        Assert.AreEqual("CONCEPTRESPONSE5_Concept1", result(5).identifier)
        Assert.AreEqual("CONCEPTRESPONSE5_Concept1-2", result(6).identifier)
        Assert.AreEqual("CONCEPTRESPONSE6_Concept2", result(7).identifier)
        Assert.AreEqual("CONCEPTRESPONSE6_Concept2-1", result(8).identifier)
        Assert.AreEqual("CONCEPTRESPONSE10_Concept2", result(9).identifier)
        Assert.AreEqual("CONCEPTRESPONSE11_Concept2", result(10).identifier)
        Assert.AreEqual("CONCEPTRESPONSE14_Concept1", result(11).identifier)
        Assert.AreEqual("CONCEPTRESPONSE14_Concept1-1", result(12).identifier)
        Assert.AreEqual("CONCEPTRESPONSE14_Concept1-2", result(13).identifier)
        Assert.AreEqual("CONCEPTRESPONSE17_Concept2", result(14).identifier)
        Assert.AreEqual("CONCEPTRESPONSE17_Concept2-1", result(15).identifier)
        Assert.AreEqual("CONCEPTRESPONSE21_Concept1", result(16).identifier)
        Assert.AreEqual("CONCEPTRESPONSE21_Concept1-1", result(17).identifier)
        Assert.AreEqual("CONCEPTRESPONSE21_Concept1-2", result(18).identifier)
        Assert.AreEqual("CONCEPTRESPONSE22_Concept1", result(19).identifier)
        Assert.AreEqual("CONCEPTRESPONSE22_Concept1-1", result(20).identifier)
    ...
    Public Sub HottextCorrection_FactSets_OutcomeDeclarationsShouldBeInRightOrder()
        ...
        Assert.AreEqual("CONCEPTRESPONSE_Concept1", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept1-1", result(2).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept1-2", result(3).identifier)
    ...
    Public Sub HottextCorrection_MultipleFactSets_OutcomeDeclarationsShouldBeInRightOrder()
        ...
        Assert.AreEqual("CONCEPTRESPONSE_Concept2", result(4).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept2-1", result(5).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_Concept1", result(6).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_Concept1-1", result(7).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_Concept2", result(8).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_Concept2-1", result(9).identifier)
    ...
    Public Sub HottextCorrection_CombinationOfFactSetsAndFactsOnFinding_OutcomeDeclarationsShouldBeInRightOrder()
        ...
        Assert.AreEqual("CONCEPTRESPONSE_Concept1", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept1-1", result(2).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept2", result(3).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept2-1", result(4).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_Concept1", result(5).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_Concept1-1", result(6).identifier)
        Assert.AreEqual("CONCEPTRESPONSE7_Concept2", result(7).identifier)
        Assert.AreEqual("CONCEPTRESPONSE7_Concept2-1", result(8).identifier)
        Assert.AreEqual("CONCEPTRESPONSE12_Concept1", result(9).identifier)
    ...
    Public Sub Formula_CasEqual_FactsOnFinding()
        ...
        Assert.AreEqual("CONCEPTRESPONSE_Concept1", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_Concept1-1", result(2).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_Concept2", result(3).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_Concept2-1", result(4).identifier)
    ...
    Public Sub Formula_CasEqual_Multiple_FactsOnFinding()
        ...
        Assert.AreEqual("CONCEPTRESPONSE4_Concept1", result(5).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_Concept1-1", result(6).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_Concept1-2", result(7).identifier)
        Assert.AreEqual("CONCEPTRESPONSE5_Concept1", result(8).identifier)
    ...
    Public Sub Formula_CasEqual_Mixed_FactsOnFinding()
        ...
        Assert.AreEqual(9, result.Count)
        Assert.AreEqual("SCORE", result(0).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_Concept1", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE2_Concept1-1", result(2).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_Concept2", result(3).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_Concept2-1", result(4).identifier)
        Assert.AreEqual("CONCEPTRESPONSE7_Concept1", result(5).identifier)
        Assert.AreEqual("CONCEPTRESPONSE7_Concept1-1", result(6).identifier)
        Assert.AreEqual("CONCEPTRESPONSE7_Concept1-2", result(7).identifier)
        Assert.AreEqual("CONCEPTRESPONSE8_Concept1", result(8).identifier)
    ...
    Public Sub McWithInlineCI_CombinationOfFactSetsAndFactsOnFinding()
        ...
        Assert.AreEqual(9, result.Count)
        Assert.AreEqual("SCORE", result(0).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_B", result(1).identifier)
        Assert.AreEqual("CONCEPTRESPONSE_B1", result(2).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_A", result(3).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_A1", result(4).identifier)
        Assert.AreEqual("CONCEPTRESPONSE3_A11", result(5).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_A", result(6).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_A1", result(7).identifier)
        Assert.AreEqual("CONCEPTRESPONSE4_A11", result(8).identifier)
                        ...
                        <div class="div_right_inner">
                            ...
                            <div>
                                <gapMatchInteraction responseIdentifier="gapMatchController" shuffle="false">
                                    <gapText identifier="A" matchMax="1">am going</gapText>
                                    <gapText identifier="B" matchMax="1">in July</gapText>
                                    <gapText identifier="C" matchMax="1">on holiday</gapText>
                                    <gapText identifier="D" matchMax="1">to France</gapText>
            ...
            <itemBody class="defaultBody">
                <div class="content">
                    <div xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <div id="questionwithinlinecontrol">
                            <p id="c1-id-11">
                                <extendedTextInteraction id="I5a35f7d3-acbc-4c02-8653-77e8bd20788c" responseIdentifier="I5a35f7d3-acbc-4c02-8653-77e8bd20788c"/> </p>
                        </div>
                        <div id="answer">
                    ...
                    <div xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <div id="questionwithinlinecontrol">
                            <p id="c1-id-11">
                                <extendedTextInteraction id="I5a35f7d3-acbc-4c02-8653-77e8bd20788c" responseIdentifier="I5a35f7d3-acbc-4c02-8653-77e8bd20788c"/> </p>
                            <p id="c1-id-12">
                                <extendedTextInteraction id="I7b9b4ad0-6eb5-4928-b09d-16264ff8f120" responseIdentifier="I7b9b4ad0-6eb5-4928-b09d-16264ff8f120"/> </p>
                        </div>
                        <div id="answer">
            ...
            <itemBody class="defaultBody">
                <div class="content">
                    <div xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <div id="questionwithinlinecontrol">
                            <p id="c1-id-11">
                                <textEntryInteraction patternMask="^-?([0-9]{1,5})?$" responseIdentifier="If5d399bf-f82e-4faf-bebd-c3bfa23fbfb1" expectedLength="6"/> </p>
                            <p id="c1-id-12">
                                <extendedTextInteraction id="I5a35f7d3-acbc-4c02-8653-77e8bd20788c" responseIdentifier="I5a35f7d3-acbc-4c02-8653-77e8bd20788c"/> </p>
                            <p id="c1-id-13">
                                <span>
                                    <textEntryInteraction patternMask="^(([0-1]?[0-9])|([2][0-3]))$" responseIdentifier="If7c2200d-0063-4a23-a58c-2a38deea8529" expectedLength="2" timeSubType="hhmm"/>



                                    <textEntryInteraction patternMask="^([0-5]?[0-9])$" responseIdentifier="If7c2200d-0063-4a23-a58c-2a38deea8529" expectedLength="2" timeSubType="hhmm"/>
                                </span> </p>
                            <p id="c1-id-14">
                                <textEntryInteraction patternMask="^.{0,5}$" responseIdentifier="Ie7f3c962-96d9-417f-a793-0c506c67ec1d" expectedLength="5"/> </p>
                            <p id="c1-id-15">
                                <extendedTextInteraction id="I7b9b4ad0-6eb5-4928-b09d-16264ff8f120" responseIdentifier="I7b9b4ad0-6eb5-4928-b09d-16264ff8f120"/> </p>
                        </div>
                        <div id="answer">
                    ...
                    <div class="div_right" xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <div class="div_right_inner">
                            <div id="itemquestion">
                                ...
                                <p id="c1-id-14">
                                    <choiceInteraction id="I6cc75685-147c-4a91-a899-791aa0201e6f" class="" shuffle="false" responseIdentifier="I6cc75685-147c-4a91-a899-791aa0201e6f" maxChoices="0">
                                        <simpleChoice identifier="I6cc75685-147c-4a91-a899-791aa0201e6fA">
                                            <p id="c1-id-11">a</p>
                                        </simpleChoice>
                                        <simpleChoice identifier="I6cc75685-147c-4a91-a899-791aa0201e6fB">
                                            <p id="c1-id-11">b</p>
                                        </simpleChoice>
                                        <simpleChoice identifier="I6cc75685-147c-4a91-a899-791aa0201e6fC">
                                            <p id="c1-id-11">c</p>
                                        </simpleChoice>
                                        <simpleChoice identifier="I6cc75685-147c-4a91-a899-791aa0201e6fD">
                                            <p id="c1-id-11">d</p>
                                        </simpleChoice>
                                        <simpleChoice identifier="I6cc75685-147c-4a91-a899-791aa0201e6fE">
                                            <p id="c1-id-11">e</p>
                                        </simpleChoice>
                                        <simpleChoice identifier="I6cc75685-147c-4a91-a899-791aa0201e6fF">
                                            <p id="c1-id-11">f</p>
                                        </simpleChoice>
                                    </choiceInteraction> </p>
                                <p id="c1-id-15">
                   ...
                   <div class="div_right">
                       ...
                       <div class="div_right_inner">
                           <div id="body">
                               <p id="c1-id-11">
                                   <span class="inlinecontrol">
                                       <customInteraction responseIdentifier="I59fb10a4-be7d-4c15-b655-ccd57bfacfd6">
                                           <html:object xmlns:html="http://www.w3.org/1999/xhtml" type="application/javascript" height="400" width="400" data="resource://package/dtt-wi-DWOtest1CI.ci">
                               ...
                               <p id="c1-id-12">
                                   <span class="inlinecontrol">
                                       <customInteraction responseIdentifier="I880ab1e3-b1ea-4e1f-a769-cf763f00969c">
                                           <html:object xmlns:html="http://www.w3.org/1999/xhtml" type="application/javascript" height="400" width="400" data="resource://package/test1.ci">
                                               <!-- + 1 because first entry is reserved to save state -->
                                               <param name="responseLength" value="1" valuetype="DATA"/>
                                           </html:object>
                                       </customInteraction>
                           ...
                           <div id="question">
                               ...
                               <p id="c1-id-12">
                                   <span class="inlinecontrol">
                                       <customInteraction responseIdentifier="Ie7ea5301-245a-44c6-a961-a4864bd35c64">
                                           <html:object xmlns:html="http://www.w3.org/1999/xhtml" type="application/vnd.GeoGebra.file" height="400" width="400" data="resource://package/dtt-wi-GGBtest.ggb">
