...
<TestClass()>
Public Class QTI22ResponseDeclarationCustomInteractionTests
    ...
    Public Sub CI_Test()
        RunResponseDeclarationTest(_itemBody1, _solution1, GetCustomInteractionScoringParams(), _result1, 1)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub CI_NoFinding_Test()
        RunResponseDeclarationTest(_itemBody1, _solution2, GetCustomInteractionScoringParams(), _result2, 1)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub CI_Factset_Test()
        RunResponseDeclarationTest(_itemBody1, _solution3, GetCustomInteractionScoringParams(), _result3, 1)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub CI_FindingFactsAndFactset_Test()
        RunResponseDeclarationTest(_itemBody1, _solution4, GetCustomInteractionScoringParams(), _result4, 1)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub CI_Factsets_Test()
        RunResponseDeclarationTest(_itemBody1, _solution5, GetCustomInteractionScoringParams(), _result5, 1)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub CI_InCompleteFinding_Test()
        RunResponseDeclarationTest(_itemBody1, _solution6, GetCustomInteractionScoringParams(), _result6, 1)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub CI_Factset_InCompleteFinding_Test()
        RunResponseDeclarationTest(_itemBody1, _solution7, GetCustomInteractionScoringParams(), _result7, 1)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub CI_Type3_Test()
        RunResponseDeclarationTest(_itemBody_Type3, _solution_Type3_1, GetCustomInteractionScoringParams_Type3And4, _result_Type3_1, 1)
    End Sub

    <TestMethod(), TestCategory("Publication"), TestCategory("QTIScoring"), TestCategory("CesResponseDeclaration")>
    Public Sub CI_Type4_Test()
        RunResponseDeclarationTest(_itemBody_Type4, _solution_Type4_1, GetCustomInteractionScoringParams_Type3And4, _result_Type4_1, 1)
    End Sub
    ...
    Private _result1 As XElement =
        <responseDeclarations>
            <responseDeclaration identifier="RESPONSE" cardinality="ordered" baseType="string">
                <correctResponse interpretation="12345&amp;D&amp;B&amp;F">
                    <value>12345</value>
                    <value>D</value>
                    <value>B</value>
                    <value>F</value>
    ...
    Private _result3 As XElement =
        <responseDeclarations>
            <responseDeclaration identifier="RESPONSE" cardinality="ordered" baseType="string">
                <correctResponse interpretation="(12345&amp;D&amp;B&amp;F)|(54321&amp;D&amp;B&amp;E)">
                    <value>12345</value>
                    <value>D</value>
                    <value>B</value>
                    <value>F</value>
    ...
    Private _result4 As XElement =
        <responseDeclarations>
            <responseDeclaration identifier="RESPONSE" cardinality="ordered" baseType="string">
                <correctResponse interpretation="(12345&amp;B)|(54321&amp;B)&amp;D&amp;F">
                    <value>12345</value>
                    <value>D</value>
                    <value>B</value>
                    <value>F</value>
    ...
    Private _result5 As XElement =
        <responseDeclarations>
            <responseDeclaration identifier="RESPONSE" cardinality="ordered" baseType="string">
                <correctResponse interpretation="(12345&amp;B)|(54321&amp;B)&amp;(D&amp;F)|(C&amp;E)|(B&amp;D)">
                    <value>12345</value>
                    <value>D</value>
                    <value>B</value>
                    <value>F</value>
    ...
    Private _result6 As XElement =
        <responseDeclarations>
            <responseDeclaration identifier="RESPONSE" cardinality="ordered" baseType="string">
                <correctResponse interpretation="12345&amp;D&amp;F">
                    <value>12345</value>
                    <value>D</value>
                    <value>F</value>
                </correctResponse>
    ...
    Private _result7 As XElement =
        <responseDeclarations>
            <responseDeclaration identifier="RESPONSE" cardinality="ordered" baseType="string">
                <correctResponse interpretation="(D&amp;B&amp;F)|(54321&amp;B&amp;E)">
                    <value>D</value>
                    <value>B</value>
                    <value>F</value>
                </correctResponse>
    ...
    Private _result_Type3_1 As XElement =
         <responseDeclarations>
             <responseDeclaration identifier="RESPONSE" cardinality="ordered" baseType="float">
                 <correctResponse interpretation="(0.9-1.1&amp;0.9-1.1)&amp;(1.9-2.1&amp;1.9-2.1)&amp;(2.9-3.1&amp;2.9-3.1)&amp;(3.9-4.1&amp;3.9-4.1)">
                     <value>0.9</value>
                     <value>0.9</value>
                     <value>1.9</value>
                     <value>1.9</value>
    ...
    Private _result_Type4_1 As XElement =
        <responseDeclarations>
            <responseDeclaration identifier="RESPONSE" cardinality="ordered" baseType="float">
                <correctResponse interpretation="(1&amp;3)&amp;(2&amp;6)&amp;(3&amp;9)&amp;(4&amp;12)">
                    <value>1</value>
                    <value>3</value>
                    <value>2</value>
                    <value>6</value>
