...
Namespace Questify.Builder.Model.ContentModel.EntityClasses
    ...
    Public Class PackageResourceEntity
        ...
        Protected Overrides Function GetRelationsForFieldOfType(fieldName As String) As RelationCollection
            Return PackageResourceEntity.GetRelationsForField(fieldName)
        End Function
...
#End If
        ...
        Public Shadows Shared Function GetEntityTypeFilter() As IPredicateExpression
            Return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("PackageResourceEntity", False)
        End Function

        Public Shadows Shared Function GetEntityTypeFilter(negate As Boolean) As IPredicateExpression
            Return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("PackageResourceEntity", negate)
        End Function
        ...
        Protected Overrides Function CheckIfIsSubTypeOf(typeOfEntity As Integer) As Boolean
            Return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("PackageResourceEntity", CType(typeOfEntity, Questify.Builder.Model.ContentModel.EntityType).ToString())
        End Function

        Protected Overrides Overloads Function GetAllRelations() As List(Of IEntityRelation)
            Return New PackageResourceRelations().GetAllRelations()
        End Function

        Protected Overrides Function CreateEntityFactory() As IEntityFactory2
            Return EntityFactoryCache2.GetEntityFactory(GetType(PackageResourceEntityFactory))
        End Function
#If Not CF Then
...
#End If
        ...
        Public Shadows Shared ReadOnly Property Relations() As PackageResourceRelations
            Get
                Return New PackageResourceRelations()
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
            Get
                Return PackageResourceEntity.CustomProperties
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
            Get
                Return PackageResourceEntity.FieldsCustomProperties
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
            Get
                Return CInt(Questify.Builder.Model.ContentModel.EntityType.PackageResourceEntity)
            End Get
        End Property
