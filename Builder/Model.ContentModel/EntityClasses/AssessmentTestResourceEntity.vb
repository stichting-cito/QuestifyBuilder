...
Namespace Questify.Builder.Model.ContentModel.EntityClasses
    ...
    <Serializable()> _
    Public Class AssessmentTestResourceEntity
        ...
        Public Sub New()
            MyBase.New()
            InitClassEmpty()
            SetName("AssessmentTestResourceEntity")
        End Sub
        ...
        Protected Overrides Function GetRelationsForFieldOfType(fieldName As String) As RelationCollection
            Return AssessmentTestResourceEntity.GetRelationsForField(fieldName)
        End Function
...
#End If
        ...
        Public Shadows Shared Function GetEntityTypeFilter() As IPredicateExpression
            Return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("AssessmentTestResourceEntity", False)
        End Function

        Public Shadows Shared Function GetEntityTypeFilter(negate As Boolean) As IPredicateExpression
            Return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("AssessmentTestResourceEntity", negate)
        End Function
        ...
        Protected Overrides Function CheckIfIsSubTypeOf(typeOfEntity As Integer) As Boolean
            Return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("AssessmentTestResourceEntity", CType(typeOfEntity, Questify.Builder.Model.ContentModel.EntityType).ToString())
        End Function

        Protected Overrides Overloads Function GetAllRelations() As List(Of IEntityRelation)
            Return New AssessmentTestResourceRelations().GetAllRelations()
        End Function

        Protected Overrides Function CreateEntityFactory() As IEntityFactory2
            Return EntityFactoryCache2.GetEntityFactory(GetType(AssessmentTestResourceEntityFactory))
        End Function
#If Not CF Then
...
#End If
        ...
        Public Shadows Shared ReadOnly Property Relations() As AssessmentTestResourceRelations
            Get
                Return New AssessmentTestResourceRelations()
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
            Get
                Return AssessmentTestResourceEntity.CustomProperties
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
            Get
                Return AssessmentTestResourceEntity.FieldsCustomProperties
            End Get
        End Property

        Public Overridable Property [IsTemplate]() As System.Boolean
            Get
                Return CType(GetValue(CInt(AssessmentTestResourceFieldIndex.IsTemplate), True), System.Boolean)
            End Get
            Set
                SetValue(CInt(AssessmentTestResourceFieldIndex.IsTemplate), value)
            End Set
        End Property
        ...
        Protected Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
            Get
                Return CInt(Questify.Builder.Model.ContentModel.EntityType.AssessmentTestResourceEntity)
            End Get
        End Property
