...
Namespace Questify.Builder.Model.ContentModel.EntityClasses
    ...
    <Serializable()> _
    Public Class ItemLayoutTemplateResourceEntity
        ...
        Public Sub New()
            MyBase.New()
            InitClassEmpty()
            SetName("ItemLayoutTemplateResourceEntity")
        End Sub
        ...
        Protected Overrides Function GetRelationsForFieldOfType(fieldName As String) As RelationCollection
            Return ItemLayoutTemplateResourceEntity.GetRelationsForField(fieldName)
        End Function
...
#End If
        ...
        Public Shadows Shared Function GetEntityTypeFilter() As IPredicateExpression
            Return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ItemLayoutTemplateResourceEntity", False)
        End Function

        Public Shadows Shared Function GetEntityTypeFilter(negate As Boolean) As IPredicateExpression
            Return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("ItemLayoutTemplateResourceEntity", negate)
        End Function
        ...
        Protected Overrides Function CheckIfIsSubTypeOf(typeOfEntity As Integer) As Boolean
            Return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("ItemLayoutTemplateResourceEntity", CType(typeOfEntity, Questify.Builder.Model.ContentModel.EntityType).ToString())
        End Function

        Protected Overrides Overloads Function GetAllRelations() As List(Of IEntityRelation)
            Return New ItemLayoutTemplateResourceRelations().GetAllRelations()
        End Function

        Protected Overrides Function CreateEntityFactory() As IEntityFactory2
            Return EntityFactoryCache2.GetEntityFactory(GetType(ItemLayoutTemplateResourceEntityFactory))
        End Function
#If Not CF Then
...
#End If
        ...
        Public Shadows Shared ReadOnly Property Relations() As ItemLayoutTemplateResourceRelations
            Get
                Return New ItemLayoutTemplateResourceRelations()
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
            Get
                Return ItemLayoutTemplateResourceEntity.CustomProperties
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
            Get
                Return ItemLayoutTemplateResourceEntity.FieldsCustomProperties
            End Get
        End Property

        Public Overridable Property [ItemType]() As System.String
            Get
                Return CType(GetValue(CInt(ItemLayoutTemplateResourceFieldIndex.ItemType), True), System.String)
            End Get
            Set
                SetValue(CInt(ItemLayoutTemplateResourceFieldIndex.ItemType), value)
            End Set
        End Property
        ...
        Protected Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
            Get
                Return CInt(Questify.Builder.Model.ContentModel.EntityType.ItemLayoutTemplateResourceEntity)
            End Get
        End Property
