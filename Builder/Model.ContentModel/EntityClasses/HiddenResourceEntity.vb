...
Namespace Questify.Builder.Model.ContentModel.EntityClasses
    ...
    <Serializable()> _
    Public Class HiddenResourceEntity
        ...
        Public Sub New()
            MyBase.New("HiddenResourceEntity")
        ...
        Public Sub New(resourceId As System.Guid, bankId As System.Int32)
            MyBase.New("HiddenResourceEntity")
            InitClassEmpty(Nothing, Nothing)
        ...
        Public Sub New(resourceId As System.Guid, bankId As System.Int32, validator As IValidator)
            MyBase.New("HiddenResourceEntity")
            InitClassEmpty(validator, Nothing)
            Me.ResourceId = resourceId
            Me.BankId = bankId
        ...
        Protected Overrides Sub PerformDesyncSetupFKFieldChange(fieldIndex As Integer)
            Select Case CType(fieldIndex, HiddenResourceFieldIndex)
                Case HiddenResourceFieldIndex.ResourceId
        ...
        Protected Overrides Function GetRelationsForFieldOfType(fieldName As String) As RelationCollection
            Return HiddenResourceEntity.GetRelationsForField(fieldName)
        End Function
        ...
        Friend Shared Function GetRelationsForField(fieldName As String) As RelationCollection
            ...
            Select Case fieldName
                Case "Resource"
                    toReturn.Add(HiddenResourceEntity.Relations.ResourceEntityUsingResourceId)
                Case Else
            End Select
            Return toReturn
        End Function
...
#End If
        ...
        Protected Overrides Overloads Function GetAllRelations() As List(Of IEntityRelation)
            Return New HiddenResourceRelations().GetAllRelations()
        End Function
        ...
        Protected Overrides Function CreateEntityFactory() As IEntityFactory2
            Return EntityFactoryCache2.GetEntityFactory(GetType(HiddenResourceEntityFactory))
        End Function
#If Not CF Then
...
#End If
        ...
        Private Sub DesetupSyncResource(signalRelatedEntity As Boolean, resetFKFields As Boolean)
            Me.PerformDesetupSyncRelatedEntity(_resource, AddressOf OnResourcePropertyChanged, "Resource", Questify.Builder.Model.ContentModel.RelationClasses.StaticHiddenResourceRelations.ResourceEntityUsingResourceIdStatic, True, signalRelatedEntity, "HiddenResourceCollection", resetFKFields, New Integer() {CInt(HiddenResourceFieldIndex.ResourceId)})
            _resource = Nothing
        End Sub
        ...
        Private Sub SetupSyncResource(relatedEntity As IEntityCore)
            If Not _resource Is relatedEntity Then
                ...
                Me.PerformSetupSyncRelatedEntity(_resource, AddressOf OnResourcePropertyChanged, "Resource", Questify.Builder.Model.ContentModel.RelationClasses.StaticHiddenResourceRelations.ResourceEntityUsingResourceIdStatic, True, New String() {})
            End If
        End Sub
        ...
        Public Shared ReadOnly Property Relations() As HiddenResourceRelations
            Get
                Return New HiddenResourceRelations()
            End Get
        End Property
        ...
        Public Shared ReadOnly Property PrefetchPathResource() As IPrefetchPathElement2
            Get
                Return New PrefetchPathElement2(New EntityCollection(EntityFactoryCache2.GetEntityFactory(GetType(ResourceEntityFactory))), _
                    CType(GetRelationsForField("Resource")(0), IEntityRelation), CType(Questify.Builder.Model.ContentModel.EntityType.HiddenResourceEntity, Integer), CType(Questify.Builder.Model.ContentModel.EntityType.ResourceEntity, Integer), 0, Nothing, Nothing, Nothing, Nothing, "Resource", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne)
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
            Get
                Return HiddenResourceEntity.CustomProperties
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
            Get
                Return HiddenResourceEntity.FieldsCustomProperties
            End Get
        End Property

        Public Overridable Property [ResourceId]() As System.Guid
            Get
                Return CType(GetValue(CInt(HiddenResourceFieldIndex.ResourceId), True), System.Guid)
            End Get
            Set
                SetValue(CInt(HiddenResourceFieldIndex.ResourceId), value)
            End Set
        End Property
        Public Overridable Property [BankId]() As System.Int32
            Get
                Return CType(GetValue(CInt(HiddenResourceFieldIndex.BankId), True), System.Int32)
            End Get
            Set
                SetValue(CInt(HiddenResourceFieldIndex.BankId), value)
            End Set
        End Property
        ...
        Public Overridable Property [Resource]() As ResourceEntity
            ...
            Set
                ...
                Else
                    SetSingleRelatedEntityNavigator(value, "HiddenResourceCollection", "Resource", _resource, True)
                End If
            End Set
        End Property
        ...
        Protected Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
            Get
                Return CInt(Questify.Builder.Model.ContentModel.EntityType.HiddenResourceEntity)
            End Get
        End Property
