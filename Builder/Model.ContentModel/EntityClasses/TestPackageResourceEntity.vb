...
Namespace Questify.Builder.Model.ContentModel.EntityClasses
    ...
    <Serializable()> _
    Public Class TestPackageResourceEntity
        ...
        Public Sub New()
            MyBase.New()
            InitClassEmpty()
            SetName("TestPackageResourceEntity")
        End Sub
        ...
        Protected Overrides Function GetRelationsForFieldOfType(fieldName As String) As RelationCollection
            Return TestPackageResourceEntity.GetRelationsForField(fieldName)
        End Function
...
#End If
        ...
        Public Shadows Shared Function GetEntityTypeFilter() As IPredicateExpression
            Return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("TestPackageResourceEntity", False)
        End Function

        Public Shadows Shared Function GetEntityTypeFilter(negate As Boolean) As IPredicateExpression
            Return InheritanceInfoProviderSingleton.GetInstance().GetEntityTypeFilter("TestPackageResourceEntity", negate)
        End Function
        ...
        Protected Overrides Function CheckIfIsSubTypeOf(typeOfEntity As Integer) As Boolean
            Return InheritanceInfoProviderSingleton.GetInstance().CheckIfIsSubTypeOf("TestPackageResourceEntity", CType(typeOfEntity, Questify.Builder.Model.ContentModel.EntityType).ToString())
        End Function

        Protected Overrides Overloads Function GetAllRelations() As List(Of IEntityRelation)
            Return New TestPackageResourceRelations().GetAllRelations()
        End Function

        Protected Overrides Function CreateEntityFactory() As IEntityFactory2
            Return EntityFactoryCache2.GetEntityFactory(GetType(TestPackageResourceEntityFactory))
        End Function
#If Not CF Then
...
#End If
        ...
        Public Shadows Shared ReadOnly Property Relations() As TestPackageResourceRelations
            Get
                Return New TestPackageResourceRelations()
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property CustomPropertiesOfType() As Dictionary(Of String, String)
            Get
                Return TestPackageResourceEntity.CustomProperties
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property FieldsCustomPropertiesOfType() As Dictionary(Of String, Dictionary(Of String, String))
            Get
                Return TestPackageResourceEntity.FieldsCustomProperties
            End Get
        End Property
        ...
        Protected Overrides ReadOnly Property LLBLGenProEntityTypeValue As Integer
            Get
                Return CInt(Questify.Builder.Model.ContentModel.EntityType.TestPackageResourceEntity)
            End Get
        End Property
