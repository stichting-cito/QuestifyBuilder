...
Namespace Questify.Builder.Model.ContentModel.RelationClasses
    Public Class ResourceHistoryRelations
        Public Sub New()
        End Sub
        ...
        Public Overridable ReadOnly Property ResourceEntityUsingResourceId() As IEntityRelation
            Get
                ...
                relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("ResourceHistoryEntity", True)
                Return relation
            End Get
        End Property
    ...
    Friend Class StaticResourceHistoryRelations
        Friend Shared ReadOnly ResourceEntityUsingResourceIdStatic As IEntityRelation = New ResourceHistoryRelations().ResourceEntityUsingResourceId
