...
{
    [TestClass]
    public class BankEntityCacheTest : EntityCacheTestBase<BankEntity>
    {
        ...
        [TestMethod, TestCategory("Cache")]
        public new void CachedNewItemsShouldGetNewExpiryTime_NonSlidedTest()
        {
            System.Threading.Thread.CurrentPrincipal = new TestBuilderPrincipal(new TestBuilderIdentity(1, "administrator", "default"));
            base.CachedNewItemsShouldGetNewExpiryTime_NonSlidedTest();
        }
    }
}
