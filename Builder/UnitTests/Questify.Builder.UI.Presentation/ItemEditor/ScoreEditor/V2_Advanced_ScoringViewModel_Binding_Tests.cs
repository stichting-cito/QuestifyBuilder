...
namespace Questify.Builder.UnitTests.Questify.Builder.UI.Presentation.ItemEditor.ScoreEditor
{
    ...
    public class V2_Advanced_ScoringViewModel_Binding_Tests : UsesTheItemEditorVM
    {
        ...
        private static class Defined_Solutions
        {
            ...
            {
                public const string Id = "C20D731F-CC46-470B-91B2-70063B4A80C3"; public static XElement Data = XElement.Parse(@"<solution xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema""></solution>");
            ...
            {
                public const string Id = "A2C566A9-DA35-4E15-9182-D6B53B65EC34"; public static XElement Data = XElement.Parse(@"<solution xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
                                                              <keyFindings>
    ...
    XElement.Parse(@"<solution>
            ...
            {
                public const string Id = "{07606F8B-4403-490A-9181-BC8035CB558C}"; public static XElement Data =
    XElement.Parse(@"<solution>
                                        <keyFindings>
