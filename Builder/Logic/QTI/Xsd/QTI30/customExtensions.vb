...
Namespace QTI.Xsd.QTI30
    ...
    Partial Public Class ManifestType
        <XmlAttribute("schemaLocation", Namespace:="http://www.w3.org/2001/XMLSchema-instance")>
        Public xsiSchemaLocation As String = "http://www.imsglobal.org/xsd/imsqtiasi_v3p0 controlxsds/imsqti_asiv3p0_v1p0.xsd http://ltsc.ieee.org/xsd/LOM controlxsds/imsmd_loose_v1p3p2.xsd
