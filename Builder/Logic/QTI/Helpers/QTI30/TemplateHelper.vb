...
Namespace QTI.Helpers.QTI30
    ...
    Public Class TemplateHelper
        ...
        Public Function GetParsedTemplate(item As AssessmentItem, ByRef itemMetaDataCollection As MetaDataCollection, itemcode As String, packageCreator As PackageCreator, assessmentTestViewType As String) As String
        ...
        Public Overridable Function GetQtiTemplate(parsedTemplate As String) As String
            Return GetQtiTemplate(parsedTemplate, New List(Of String)(New String() {"qtiextension", "qtiWithExtension", "qti2"}))
        End Function
            ...
            Return ChainHandlerHelper.RemoveAttribute(
                        ChainHandlerHelper.RemoveAttribute(
                            ChainHandlerHelper.RemoveNamespaces(
                                ChainHandlerHelper.ReplaceTags(
                                    ChainHandlerHelper.RemoveTags(
                                        ChainHandlerHelper.RemoveTags(parsedTemplate, tagsToRemove),
                                    New List(Of String)(New String() {"qti3", "qtiWithoutExtension"}), True),
                                tagsToReplace),
                            Nothing, True),
                        "cito", True),
