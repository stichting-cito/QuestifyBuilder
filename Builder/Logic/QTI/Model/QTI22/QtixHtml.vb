...
Namespace QTI.Model.QTI22
    ...
    Public Class QtixHtml
        ...
        Private _packageCreator As QTI22PackageCreator


        Public Sub New(xHtml As String, itemCode As String, isPreview As Boolean, resources As ConcurrentDictionary(Of String, Dictionary(Of ResourceType, List(Of String))), resourceMimeTypeDictionary As ConcurrentDictionary(Of String, String), css As String, resourceHelper As ResourceHelper, packageCreator As QTI22PackageCreator)
            _xHtml = xHtml
            _itemCode = itemCode
        ...
        Public Sub Convert()
            If Not _isConverted Then
                Dim ch = New ConverterHelper(Of QTI22PublicationRequest)
                ...
                _qti = xmlDoc.DocumentElement.SelectSingleNode("itemBody").OuterXml
        ...
        Private Function ExtractStylesheets(xmlDoc As XmlDocument) As List(Of StyleSheetType)
            ...
            Dim styleSheetNodes As XmlNodeList = xmlDoc.SelectNodes("//stylesheet", xmlnamespaceManager)
            If styleSheetNodes IsNot Nothing Then
                Dim helper As New QTI22StyleSheetHelper
