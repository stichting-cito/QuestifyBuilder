...
Namespace QTI.Converters.Declaration.QTI30
    ...
    Public Class ResponseDeclarationInput
        ...
        Public Sub New(gapType As QTI30CombinedScoringHelper.EnumGapType)
            _gapType = gapType
        End Sub
        ...
        Public Overrides Function GetMappings(fact As KeyFact) As List(Of MapEntryType)
            Dim mappings As New List(Of MapEntryType)
            For Each correctResponse As ValueType In GetCorrectResponses(fact, , True)
