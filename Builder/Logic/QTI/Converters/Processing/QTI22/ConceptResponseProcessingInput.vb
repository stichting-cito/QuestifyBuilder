...
Namespace QTI.Converters.Processing.QTI22
    ...
    Public Class ConceptResponseProcessingInput
        ...
        Public Sub New(responseIndex As Integer, owner As ResponseProcessingCustomOperators, scoringParam As ScoringParameter, decimalSeparator As CombinedScoringHelper.DecimalSeparator, Optional responseSubIndex As Integer = 0)
        ...
        Protected Overrides Function GetProcessingForEqualStepsValue(ByVal equalSteps As Boolean, ByVal responseIndex As Integer) As XElement
            ...
            If equalSteps = False Then processing = XElement.Parse($"<not>{processing.ToString}</not>")
            Return processing
        End Function
