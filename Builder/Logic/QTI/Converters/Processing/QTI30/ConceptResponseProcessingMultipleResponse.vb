...
Namespace QTI.Converters.Processing.QTI30
    ...
    Public Class ConceptResponseProcessingMultipleResponse
        ...
        Private Function GetCorrectResponse(fact As KeyFact) As String
            ...
            If QTI30CombinedScoringHelper.CheckIdentifierIsGuid(factId.Substring(0, pos)) Then
                Return factId.Substring(0, factId.LastIndexOf("-"))
            End If
            pos = factId.IndexOf("-")
            If QTI30CombinedScoringHelper.CheckIdentifierIsGuid(factId.Substring(pos + 1, Len(factId) - (pos + 1))) Then
