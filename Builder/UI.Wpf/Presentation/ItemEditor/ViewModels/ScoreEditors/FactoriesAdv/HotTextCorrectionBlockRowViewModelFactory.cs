...
{
    class HotTextCorrectionBlockRowViewModelFactory : GapBlockRowViewModelFactoryBase<string, HotTextCorrectionBlockRowViewModel, HotTextCorrectionScoringParameter, IGapScoringManipulator<string>>
    {
