...
Public Class InlineElementImageConverterTests
    ...
    Public Sub InlineElement_NoWhidthHeightParamsPresent_DoNotTakeOriginalImageDimensions()
        ...
        inlineElmnt.Parameters(0).InnerParameters.Add(New BooleanParameter() With {.Value = False, .Name = "editSize"}) 'Do not apply logic to set image width & height

        Dim _imgElement As XElement = <img src="http://www.eendomain.com/TestPICA.jpg" id="" alt=""/> 'This is a parameter that will be modified
    ...
    Public Sub InlineElement_WidthHeightParamsPresent_EditSizeIsTrue_DoNotTakeOriginalImageDimensions()
        ...
        inlineElmnt.Parameters(0).InnerParameters.Add(New BooleanParameter() With {.Value = True, .Name = "editSize"}) 'Do not apply logic to set image width & height
        ...
        Dim _imgElement As XElement = <img src="http://www.eendomain.com/TestPICA.jpg" width="1000" height="2000" id="" alt=""/> 'This is a parameter that will be modified
        Dim imgElement As XmlElement = _imgElement.ToXmlElement()
