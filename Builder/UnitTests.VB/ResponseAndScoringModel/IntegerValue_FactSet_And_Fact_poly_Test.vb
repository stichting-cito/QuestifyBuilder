...
<TestClass>
Public Class IntegerValue_FactSet_And_Fact_poly_Test
    Inherits ScoringTestBase

    <TestMethod()> <TestCategory("ResponseAndScoringModel")>
    Public Sub MaxScore()
        Dim solution = ToSolution(INT_Polytomous_8Or4_power)
    ...
    <TestMethod()> <TestCategory("ResponseAndScoringModel")>
    Public Sub GivePartialIncorrectAnswer_ABisWrong_ScoreShouldBe0()
        Dim solution = ToSolution(INT_Polytomous_8Or4_power)
        Dim r = GetResponse(New List(Of Integer) From {10, 20, 65536})
    ...
    <TestMethod()> <TestCategory("ResponseAndScoringModel")>
    Public Sub GivePartialIncorrectAnswer_ACisWrong_ScoreShouldBe0()
        Dim solution = ToSolution(INT_Polytomous_8Or4_power)
        Dim r = GetResponse(New List(Of Integer) From {10, 4, 100})
    ...
    <TestMethod()> <TestCategory("ResponseAndScoringModel")>
    Public Sub GivePartialIncorrectAnswer_BCisWrong_ScoreShouldBe0()
        Dim solution = ToSolution(INT_Polytomous_8Or4_power)
        Dim r = GetResponse(New List(Of Integer) From {4, 10, 45445})
    ...
    Private INT_Polytomous_8Or4_power As XElement = <solution>
                                                        <keyFindings>
