...
<TestClass>
Public Class HtmlConverter_DealWithMovedInlineElementTests

    <TestMethod(), TestCategory("UILogic")>
    Public Sub NothingToDo_NoAlterations()
        Dim converter = New HtmlConverter_DealWithMovedInlineElement(A.Fake(Of IHtmlEditorBehaviour))
    ...
    Public Sub NothingToDo_InlineIdsMatchesHtmlInlineIds()
        Dim converter = New HtmlConverter_DealWithMovedInlineElement(GetFakeWithInlineElements("Ice32c0ba-73db-456d-b3d3-c92265282cf7"))
    ...
    Public Sub NeedsToDoSomething_2htmlInlineIds_1matchInInlineId_andHasOtherIdThatIsNotPresent_HtmlIdIsRenamed()
        Dim converter = New HtmlConverter_DealWithMovedInlineElement(GetFakeWithInlineElements("Ice32c0ba-73db-456d-b3d3-c92265282cf7", "IsGone"))
    ...
    Public Sub RenameOfInlineIdAffectsIdsOfBehavior()
        ...
        Dim converter = New HtmlConverter_DealWithMovedInlineElement(fakeHtmlEditorBehavior)
    ...
    ReadOnly singleInline As XElement = <html xmlns="http://www.w3.org/1999/xhtml">
                                            <body style="padding: 2px; margin : 0; box-sizing: border-box; height: auto; width: 100%;" id="c1-id-7" xmlns="http://www.w3.org/1999/xhtml">
                                                <p id="c1-id-8">
                                                    <img id="Ice32c0ba-73db-456d-b3d3-c92265282cf7" style="VERTICAL-ALIGN: middle" alt="" src="" isinlineelement="true"/>
                                                </p>
                                            </body>
                                        </html>
    ...
    ReadOnly doubleInline As XElement = <html xmlns="http://www.w3.org/1999/xhtml">
                                            <body style="padding: 2px; margin : 0; box-sizing: border-box; height: auto; width: 100%;" id="c1-id-7" xmlns="http://www.w3.org/1999/xhtml">
                                                <p id="c1-id-8">
                                                    <img id="Ice32c0ba-73db-456d-b3d3-c92265282cf7" style="VERTICAL-ALIGN: middle" alt="" src="" isinlineelement="true"/>
                                                    <img id="c1-id-09" style="VERTICAL-ALIGN: middle" alt="" src="" isinlineelement="true"/>
                                                </p>
                                            </body>
                                        </html>
