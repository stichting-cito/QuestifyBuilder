...
<TestClass()>
Public Class BoxTableStyleHandlerTests
    ...
    Public Sub StyleIsApplied()
        ...
        Dim styleHanler As New BoxTableStyleStrategy(presenter)
    ...
    Public Sub TogglesAreSetAfterInit()
        ...
        Assert.IsTrue(styleHanler.GetInnerStatus(False)) 'Checks if set to true.
    End Sub
