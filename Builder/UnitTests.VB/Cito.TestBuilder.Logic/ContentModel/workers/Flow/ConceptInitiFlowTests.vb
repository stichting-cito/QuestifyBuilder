...
<TestClass>
Public Class ConceptInitiFlowTests
    ...
    Public Sub ValidateCopyWorking()
        ...
        Dim inputs As New Dictionary(Of String, Object) From {{"Solution", solution},
                                                              {"ScoreParameters", New ScoringParameter() {scorePrm}},
    ...
    Public Sub AfterFlowAllKeysShouldBeSetToMC_1()
        ...
        Dim mc1Facts = From fact In solution.ConceptFindings(0).Facts.Cast(Of KeyFact)() Where fact.Id.EndsWith("mc_1") Select fact
