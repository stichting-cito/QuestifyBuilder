...
Public Class AssessmentItemXhtmlParameterComparerTest
    ...
    Public Sub TestTwoAssessmentItemsWithIdenticaXhtmlParametersAndSameValues()
        ...
        xhtmlParam1.Name = "xhtmlParameter1"
        xhtmlParam2.Name = "xhtmlParameter1"
        xhtmlParam1.Value = CreateXhtmlDoc("attributeValue")
        xhtmlParam2.Value = CreateXhtmlDoc("attributeValue")
    ...
    Public Sub TestTwoAssessmentItemsWithIdenticaXhtmlParametersAndDifferentValues()
        ...
        xhtmlParam1.Name = "xhtmlParameter1"
        xhtmlParam2.Name = "xhtmlParameter1"
        xhtmlParam1.Value = CreateXhtmlDoc("attributeValue1")
        xhtmlParam2.Value = CreateXhtmlDoc("attributeValue2")
