...
Partial Class CustomInteractionResourceParameterEditorControl
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(CustomInteractionResourceParameterEditorControl))
        Me.ParameterEditorTooltip = New System.Windows.Forms.ToolTip(Me.components)
        ...
        Me.ScorableCheckBox = New System.Windows.Forms.CheckBox()
        ...
        Me.SuspendLayout
        Me.ParameterBindingSource.DataSource = GetType(Cito.Tester.ContentModel.CustomInteractionResourceParameter)
        Me.ParameterEditorTooltip.IsBalloon = true
        Me.ParameterEditorTooltip.ToolTipIcon = System.Windows.Forms.ToolTipIcon.Info
        resources.ApplyResources(Me.SelectResourceButton, "SelectResourceButton")
        Me.SelectResourceButton.Name = "SelectResourceButton"
        Me.ParameterEditorTooltip.SetToolTip(Me.SelectResourceButton, resources.GetString("SelectResourceButton.ToolTip"))
        ...
        Me.ParameterEditorTooltip.SetToolTip(Me.DeleteResourceButton, resources.GetString("DeleteResourceButton.ToolTip"))
        ...
        Me.ParameterEditorTooltip.SetToolTip(Me.EditResourceButton, resources.GetString("EditResourceButton.ToolTip"))
        Me.EditResourceButton.UseVisualStyleBackColor = true
        resources.ApplyResources(Me.TableLayoutPanel1, "TableLayoutPanel1")
        Me.TableLayoutPanel1.Controls.Add(Me.ScorableCheckBox, 0, 2)
        ...
        resources.ApplyResources(Me.ScorableCheckBox, "ScorableCheckBox")
        Me.ScorableCheckBox.DataBindings.Add(New System.Windows.Forms.Binding("Checked", Me.ParameterBindingSource, "Scorable", true))
        Me.ScorableCheckBox.Name = "ScorableCheckBox"
        Me.ScorableCheckBox.UseVisualStyleBackColor = true
        ...
        Me.Name = "CustomInteractionResourceParameterEditorControl"
        ...
        Me.DimensionsPanel.PerformLayout
    ...
    Friend WithEvents ParameterEditorTooltip As System.Windows.Forms.ToolTip
    ...
    Friend WithEvents ScorableCheckBox As CheckBox
End Class
